        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/blockrock.TransactionService/GetTransaction",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("blockrock.TransactionService", "GetTransaction"),
                );
...
pub mod transaction_service_server {
    ...
    pub const SERVICE_NAME: &str = "blockrock.TransactionService";
